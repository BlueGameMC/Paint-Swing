...
var steps = 2;
var loops = 10;
var canvasPos = [Math.random()*canvasSize-canvasSize/2,Math.random()*canvasSize-canvasSize/2];
//var canvasPos = [0,0];
var canvasVel = [Math.random()*160-80,Math.random()*160-80];
var canvasWeight = Math.random()*250+10

var bucketPos = [Math.random()*canvasSize/.5-canvasSize/2,Math.random()*canvasSize/.5-canvasSize/2];
var oldBucketPos = bucketPos.slice();
oldBucketPos[0] -= canvasPos[0];
oldBucketPos[1] -= canvasPos[1];
var bucketVel = [Math.random()*160-40,Math.random()*160-80];
var bucketWeight = Math.random()*150+10

ctx.lineWidth = Math.random()*5+2;
let bgColor = [Math.random()*205,Math.random()*205,Math.random()*205];
...
while(!escapeLoop)
{
    ...
    {
        bgColor = [Math.random()*205,Math.random()*205,Math.random()*205];
...
function draw()
{
    for (let i = 0; i < loops; i++) {
        ...
        //bucketVel[0] -= (bucketVel[0] * 0.001)/steps;
        //bucketVel[1] -= (bucketVel[1] * 0.001)/steps;
        ...
        //canvasVel[0] -= (canvasVel[0] * 0.001)/steps;
        //canvasVel[1] -= (canvasVel[1] * 0.001)/steps;
